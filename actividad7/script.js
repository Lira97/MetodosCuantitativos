...
// var leatorioLlegadas=[48.355,98.977,6.533,45.128,15.486,19.241,15.997,67.940,90.872,58.997,68.691,73.488,23.423,86.675,56.856]
// var aleatorioServicio=[83.761,14.387,51.321,72.472,5.466,84.609,29.735,59.076,76.355,29.549,61.958,17.267,10.061,45.645,86.754,35.340]
const dia = 510;
const horaComida = 300;

function probabilidadTiempoLlegadas(probabilidad)
{
  if(probabilidad >= 0 && probabilidad <= 0.19){
    return 1;
  }else if (probabilidad > 0.21 && probabilidad <= 0.45) {
    return 2;
  }else if (probabilidad > 0.46 && probabilidad <= 0.75) {
    return 3;
  }else if (probabilidad > 0.76 && probabilidad <= 0.90) {
    return 4;
  }else if (probabilidad > 0.91 && probabilidad <= 1) {
    return 5;
  return 0;
}
...
function probabilidadTiempoServicio3(probabilidad) {
  if(probabilidad > 0.01 && probabilidad <= 0.10) {
    ...
    return 1;
  }else if (probabilidad > 0.15 && probabilidad <= 0.25) {
    //tiempo de servicio 25
    return 2;
  }else if (probabilidad > 0.26 && probabilidad <= 0.60) {
    //tiempo de servicio 30
    return 3;
  }else if (probabilidad > 0.61 && probabilidad <= 0.75) {
